const names = ["이승채", "이채빈", "정교은", "이연서", "박세은", "박소연"]

const fortunes = ["오래 미뤄둔 일이 오늘은 의외로 쉽게 해결될 수 있답니다.", "재물운이 있어요", "실수해도 괜찮아요. 그 안에서 더 좋은 배움이 기다리고 있어요.",  "지나간 일은 내려놓고, 지금 눈앞의 일을 집중해보세요.", "작지만 확실한 행복이 숨어 있는 하루예요. 천천히 둘러보세요.", "오늘 하루는 마음 가는 대로 행동해보는 것도 괜찮아요.", "물 흐르듯 자연스럽게 흘러가는 하루가 될 거예요.", "무언가 새롭게 시작하기 좋은 타이밍이에요. 주저하지 마세요!"]
...
function generateFortuneForAll() {
    ...
    console.log(
            `오늘의 발표자는... ${presentor}님입니다! (행운 점수: ${highestScore}점)`
    );
}
